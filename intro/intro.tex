  ...
  \begin{frame}
    \frametitle{课程简介} \pause
	  \begin{itemize}
	    ...
	    \item{教材及参考资料} \pause
	      \begin{itemize}
	      \item{\htmladdnormallink{\textbf{Abraham Silberschatz, Operating System Concepts, 6th Edition, John Wiley \& Sons, Inc.}}{https://www.os-book.com}} \pause
	        \begin{itemize}
	        \item{10th edition is also available.} \pause
	        \end{itemize}
	      \item{\htmladdnormallink{Andrew S. Tanenbaum, Modern operating System, 2nd Edition, Prentice Hall.}{https://www.cs.vu.nl/~ast/books/mos2}} \pause
  ...
  \frametitle{Operating systems for desktop computers} \pause
	  \begin{itemize}
	    ...
	    \begin{itemize}
		    ...
		    \item{Unix} \pause
		      \begin{itemize}
		      \item{\textbf{BSD} (Berkeley Software Distribution) Unix, including \htmladdnormallink{FreeBSD}{https://www.freebsd.org/}, \htmladdnormallink{OpenBSD}{https://www.openbsd.org/} and \htmladdnormallink{NetBSD}{https://www.netbsd.org/}} \pause
